...
for (i = 0; i < jobsArr.length; i++){
	var listingDate = jobsArr[i].dateAdded;
	...
	$(".jobListings").append(
		...
		"<div class='jobWrapper'>" +  
			...
			"<div class='location'>" + jobsArr[i].address.city + "<br> " + jobsArr[i].address.state + "</div>" +
			"<div class='jobListInfo'>" + (moment(listingDate).diff( moment(), "months") * -1) + " months ago" + "</div>" + 
		"</div>" + 
		"</a>" +
		"</li>");
}
